...
interface EnvironmentBreakoutToolProps {
...
export const EnvironmentBreakoutTool: React.FC<EnvironmentBreakoutToolProps> = ({ onGenerate }) => {
    return (
        <div className="bg-[#0d1117] border border-gray-800 rounded-lg p-4 shadow-lg shadow-black/30 space-y-6">
            <div>
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h2 className="text-xl font-bold text-green-300">Environment Breakout</h2>
                </div>
