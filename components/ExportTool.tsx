...
`,
  'components/PackageManagerTool.tsx': `import React, { useState, useEffect } from 'react';
...
};`apt purge -y\\` for the specified packages. This operation removes the packages and their configuration files.\`
                    : \`Executes \\`pkg uninstall\\` for the specified packages. This is a safe operation that leaves configuration files intact.\`;
                break;
